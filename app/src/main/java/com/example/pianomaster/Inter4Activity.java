...
public class Inter4Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static boolean open_int4;
        ...
        switch (view.getId()) {
            ...
            case R.id.k10:
                switch (pos) {
                    case 1:
                    case 7:
                    case 16: playSound(b22, b17, pos, "e4");break;
            ...
            case R.id.k12:
                switch (pos) {
                    case 28:playSound(b20, b25, pos, "g4");break;
                    case 29:playSound(b22, b20, pos, "g4");break;
                    default:playSoundW();
                }
            ...
            case R.id.k13:
                switch (pos) {
                    ...
                    case 17:
                    case 31:
                        playSound(b24, b22, pos, "a4");break;
                    case 6:playSound(b17, b22, pos, "a4");break;
                    case 21:
                    case 30:
                        playSound(b22, b24, pos, "a4");break;
                    case 22:
                    case 25:
                        playSound(b29, b22, pos, "a4");break;
                    default:playSoundW();
                }
            ...
            case R.id.k14:
                switch (pos) {
                    ...
                    case 5:
                    case 20:
                        playSound(b22, b24, pos, "b4_");break;
                    default:playSoundW();
            ...
            case R.id.k15:
                switch (pos) {
                    case 4:
                    case 19:playSound(b24, b25, pos, "c5"); break;
                    case 10:
                    case 12:playSound(b27, b25, pos, "c5"); break;
                    default:playSoundW();
                }
            ...
            case R.id.k16:
                switch (pos) {
                    case 11:playSound(b25, b27, pos, "d5");break;
                    case 13:playSound(b29, b27, pos, "d5");break;
                    case 24:playSound(b22, b27, pos, "d5");break;
                    case 27:playSound(b20, b27, pos, "d5");break;
                    default:playSoundW();
                }
            ...
            case R.id.k17:
                switch (pos) {
                    case 14:playSound(b29, b27, pos, "e5");break;
                    case 15:playSound(b17, b29, pos, "e5");break;
                    case 23:
                    case 26:
                        playSound(b27, b29, pos, "e5");break;
                    default:playSoundW();
                }
            ...
            case R.id.k18:
                playSoundW();                soundPool.play(f5, 1, 1, 0, 0, 1);
                break;

            case R.id.k19:
                playSoundW();                soundPool.play(g5, 1, 1, 0, 0, 1);
                break;

            case R.id.k20:
                playSoundW();                soundPool.play(a5, 1, 1, 0, 0, 1);
                break;

            case R.id.k21:
                playSoundW();                soundPool.play(b5_, 1, 1, 0, 0, 1);
                break;

            case R.id.b1:
                playSoundW();                soundPool.play(c3sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b2:
                playSoundW();                soundPool.play(d3sh, 1, 1, 0, 0, 1);
                break;
            case R.id.b3:
                playSoundW();                soundPool.play(f3sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b4:
                playSoundW();                soundPool.play(g3sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b5:
                playSoundW();                soundPool.play(a3sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b6:
                playSoundW();                soundPool.play(c4sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b7:
                playSoundW();                soundPool.play(d4sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b8:
                playSoundW();soundPool.play(f4sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b9:
                playSoundW();                soundPool.play(g4sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b10:
                playSoundW();                soundPool.play(a4sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b11:
                playSoundW();                soundPool.play(c5sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b12:
                playSoundW();                soundPool.play(d5sh, 1, 1, 0, 0, 1);
                break;
            case R.id.b13:
                playSoundW();
            ...
            case R.id.b14:
                playSoundW();                soundPool.play(g5sh, 1, 1, 0, 0, 1);
                break;

            case R.id.b15:
                playSoundW();                soundPool.play(a5sh, 1, 1, 0, 0, 1);
                break;
